...
//        var movieFlux = movieStream();
        ...
        movieFlux
                .take(4)
                .subscribe(src.main.java.com.rp.courseUtil.Util.subscriber("sam"));

        src.main.java.com.rp.courseUtil.Util.sleepSeconds(3);

        movieFlux
                .take(3)
                .subscribe(src.main.java.com.rp.courseUtil.Util.subscriber("mike"));


        src.main.java.com.rp.courseUtil.Util.sleepSeconds(15);
